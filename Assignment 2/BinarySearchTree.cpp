...
*/
template <class Comparable>
BinarySearchTree<Comparable>::BinarySearchTree( const BinarySearchTree<Comparable> & rhs ) : ITEM_NOT_FOUND( rhs.ITEM_NOT_FOUND )
{
	root = clone(rhs.root);
} 
...
template <class Comparable>
void BinarySearchTree<Comparable>::updateElement(const Comparable& old, const Comparable& _new){
	BinaryNode<Comparable> * toBeUpdated = find(old,root);
